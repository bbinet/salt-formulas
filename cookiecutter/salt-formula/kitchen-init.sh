...
export SOURCE_REPO_URI="https://raw.githubusercontent.com/salt-formulas/salt-formulas/master/cookiecutter/salt-formula/%7B%7Bcookiecutter.project_name%7D%7D"
